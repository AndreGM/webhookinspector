...
export function Sidebar() {
  return (
    <div className="flex h-screen flex-col">
      <div className="flex h-16 items-center justify-between border-b border-zinc-700 px-4 py-5">
      ...
      <div className="flex items-center justify-between gap-2 border-b border-zinc-700 bg-zinc-800 px-4 py-2.5">
        <div className="flex-1 m-w-0 flex items-center  gap-1 text-xs font-mono text-zinc-300">
